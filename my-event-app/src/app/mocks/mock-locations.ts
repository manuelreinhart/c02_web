...
export const LOCATION: Location[] = [
  { id: 1, name: 'Grazer Messe', description: 'sth about Grazer Messe', address: 'Messeplatz 1', zipcode: '8010', location: 'Graz', countryAbb: 'AUT'},
  { id: 2, name: 'Wiener Stadthalle', description: 'sth about Wiener Stadthalle', address: 'Roland-Rainer-Platz 1', zipcode: '1150', location: 'Wien', countryAbb: 'AUT'},
  { id: 3, name: 'Pannonia Fields', description: 'sth about Pannonia Fields', address: 'Grenzlandhof', zipcode: '2425', location: 'Nickelsdorf', countryAbb: 'AUT'},
